...
A future project-page update can add a demonstration video, measured trial outcomes and a diagram/photo of the setup. The wording above intentionally avoids a success percentage or claims of general-purpose instruction following.
