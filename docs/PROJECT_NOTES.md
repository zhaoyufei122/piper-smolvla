...
A selected [48-second real-arm demonstration](https://zhaoyufei.cn/projects/piper-smolvla-demo.mp4) is now linked from the README and personal project page. A copy is stored in `media/` in this repository. This is a selected presentation recording, not a formal evaluation set. Future updates can add measured trial outcomes and a setup diagram. The wording above intentionally avoids a success percentage or claims of general-purpose instruction following.
